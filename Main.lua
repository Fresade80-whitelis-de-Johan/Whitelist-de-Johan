...
if not whitelist.isWhitelisted(game.Players.LocalPlayer) then
    game.Players.LocalPlayer:Kick("No estás autorizado para usar este script (Whitelist de Johan)")
    return
end

-- Aquí sigue tu script (todo tu menú, botones, lógica, etc.)
-- Por ejemplo:
